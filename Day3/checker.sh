...
##Takes argument, the number to check
##Returns
##	0: Valid integer
...
##Function check number in range 
##Takes 3 arguments, beginning of range, end of range, and number
##Exit codes
#	0: In range
#	1: Not in range
...
##Check ip is a valid IPv4 or not
...
##Function accepts a value, return 0 if valid positive integer, 1 not
